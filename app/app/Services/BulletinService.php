...
class BulletinService
{
    ...
    // 取得上下一則
    public function getBulletinPrevNext($id, $id_time, $type_id)
    {
        $prev = $this->repo->getBulletinPrev($id, $id_time, $type_id);
        $next = $this->repo->getBulletinNext($id, $id_time, $type_id);
